...
class PartnerSignUpStep3 extends StatefulWidget {
  const PartnerSignUpStep3({super.key});

  @override
  State<PartnerSignUpStep3> createState() => PartnerSignUpStep3State();
}

class PartnerSignUpStep3State extends State<PartnerSignUpStep3> {
