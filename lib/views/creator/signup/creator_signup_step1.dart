...
class CreatorSignUpStep1 extends StatefulWidget {
  const CreatorSignUpStep1({super.key});

  @override
  State<CreatorSignUpStep1> createState() => _CreatorSignUpStep1State();
}

class _CreatorSignUpStep1State extends State<CreatorSignUpStep1> {
...
class _FormElementsListState extends State<FormElementsList> {
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      Get.toNamed('/creator/otp/verification');
    }
  }
